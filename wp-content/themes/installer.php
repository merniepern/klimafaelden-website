...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20220304_klimafaelden_f16c10201a8060b32630_20220309191742_archive.zip';
	const ARCHIVE_SIZE		 = '72442039';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'f16c102-09191742';
    const SECONDARY_PACKAGE_HASH = '223cb98-09191742';
	const VERSION			 = '1.4.4';
